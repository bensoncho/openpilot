...
class Controls:
  ...
  def publish(self, CC, lac_log):
    ...
    # TODO: fix this
    #if self.sm.valid['modelV2'] and CS.canValid and is_ldw_enabled and self.sm['liveCalibration'].calStatus == log.LiveCalibrationData.Status.calibrated:
    #  hudControl.leftLaneDepart = ldw.left
    #  hudControl.rightLaneDepart = ldw.right
    #if AM.current_alert:
    #  hudControl.visualAlert = AM.current_alert.visual_alert
